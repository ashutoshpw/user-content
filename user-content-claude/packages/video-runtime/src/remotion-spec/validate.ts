...
import { RemotionComponentName, remotionRegistry } from "./registry";
...
export function validateNode(node: unknown): VideoNode {
...
export function validateSpec(spec: unknown): VideoNode {
